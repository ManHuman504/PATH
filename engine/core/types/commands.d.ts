 ...
 * Команды Core
 */
export type Command = CreatePathCommand | DeletePathCommand | AddNodeCommand | UpdateNodeCommand | DeleteNodeCommand | ConnectNodesCommand | DisconnectNodesCommand | CompleteNodeCommand;
